							...
							<div class="col-sm-12">
								<form method="POST" action="{{ route('verification.send') }}">
									...
									<div class="input-group mb-3">
										<button class="btn btn-primary btn-lg btn-block" type="submit">Resend Verification Email</button>
									</div>
								</form>
								...
								<form method="POST" action="{{ route('logout') }}">
									...
									<div class="input-group mb-0">
										<button type="submit" class="btn btn-outline-secondary btn-lg btn-block">Log Out</button>
									</div>
								</form>
							</div>
						</div>
